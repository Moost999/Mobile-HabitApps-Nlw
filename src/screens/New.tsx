...
export function News(){
    ...
    async function handleCreateNewHabit() {
        try{
            if(!title.trim() || weekDays.length === 0){
                return Alert.alert('novo habito', 'Informe o nome do habito e escolha uma data valida')
            }
    ...
    return(
        <View className="flex-1 bg-background px-8 pt-16">
            ...
            <TextInput 
                className="h-12 pl-4 rounded-lg mt-6 bg-zinc-900 text-white border-2 border-zinc-800 focus:border-green-600"
